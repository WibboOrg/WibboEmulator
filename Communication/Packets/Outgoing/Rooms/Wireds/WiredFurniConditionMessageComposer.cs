...
{
    internal class WiredFurniConditionMessageComposer : ServerPacket
    {
        public WiredFurniConditionMessageComposer(bool stuffTypeSelectionEnabled, int furniLimit, List<int> stuffIds, int stuffTypeId, int id, string stringParam, 
