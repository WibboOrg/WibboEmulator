...
{
    internal class WiredFurniTriggerMessageComposer : ServerPacket
    {
        public WiredFurniTriggerMessageComposer(bool stuffTypeSelectionEnabled, int furniLimit, List<int> stuffIds, int stuffTypeId, int id, string stringParam, 
