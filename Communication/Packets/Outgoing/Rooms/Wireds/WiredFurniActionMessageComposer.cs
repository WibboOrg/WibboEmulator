...
{
    internal class WiredFurniActionMessageComposer : ServerPacket
    {
        public WiredFurniActionMessageComposer(bool stuffTypeSelectionEnabled, int furniLimit, List<int> stuffIds, int stuffTypeId, int id, string stringParam, 
