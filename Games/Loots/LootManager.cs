...
public class LootManager
{
    ...
    public void Init(IQueryAdapter dbClient)
    {
        ...
        foreach (DataRow dRow in dTable.Rows)
        {
            ...
            if (this.LootItem.TryGetValue(interactionType, out var loots))
            {
                loots.Add(loot);
            }
        }
    ...
    {
        this.RarityCounter.TryGetValue(rarityLevel, out var count);
    ...
    {
        this.LootItem.TryGetValue(interactionType, out var loots);
