...
public class WiredUtillity
{
    ...
    public static void ParseMessage(RoomUser user, Room room, ref string textMessage)
    {
        if (user != null)
        {
            ...
            {
                if (textMessage.Contains("#wpcount#"))
                {
                ...
                textMessage = textMessage.Replace("#handitem#", user.CarryItemId.ToString());
                textMessage = textMessage.Replace("#enable#", user.CurrentEffect.ToString());
            }
