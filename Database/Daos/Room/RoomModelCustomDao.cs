...
internal class RoomModelCustomDao
{
    ...
    internal static void InsertDuplicate(IQueryAdapter dbClient, int roomId, int oldRoomId) => dbClient.RunQuery("INSERT INTO `room_model_custom` (room_id, door_x, door_y, door_z, door_dir, heightmap, wall_height) " +
